...
productsController.get("/", async (req, res) => {
  let { category, sortBy, order, pageSize, limit, brand, title, filter, q } =
    req.query;
  ...
  if (search) {
    ...
    res.status(200).json({ status: "All searched data", data: productData });
...
// Export the productsController for use in other parts of the application
